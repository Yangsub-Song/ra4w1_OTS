...
/******************************************************************************
 * Function Name: ots_cb
 * Description  : Callback function for Object Transfer Service server feature.
 * Arguments    : uint16_t type -
 *                  Event type of Object Transfer Service server feature.
 *              : ble_status_t result -
 *                  Event result of Object Transfer Service server feature.
 *              : st_ble_servs_evt_data_t *p_data - 
 *                  Event parameters of Object Transfer Service server feature.
 * Return Value : none
 ******************************************************************************/
static void ots_cb(uint16_t type, ble_status_t result, st_ble_servs_evt_data_t *p_data)
{
/* Hint: Input common process of callback function such as variable definitions */
/* Start user code for Object Transfer Service Server callback function common process. Do not edit comment generated here */
/* End user code. Do not edit comment generated here */

    switch(type)
    {
/* Hint: Add cases of Object Transfer Service server events defined in e_ble_ots_event_t */
/* Start user code for Object Transfer Service Server callback function event process. Do not edit comment generated here */
/* End user code. Do not edit comment generated here */
    }

/* Start user code for Object Transfer Service Server callback function closing process. Do not edit comment generated here */
/* End user code. Do not edit comment generated here */
}
...
/* End user code. Do not edit comment generated here */
    ...
    /* Initialize Object Transfer Service server API */
    status = R_BLE_OTS_Init(ots_cb);
    if (BLE_SUCCESS != status)
    {
        return BLE_ERR_INVALID_OPERATION;
    }
